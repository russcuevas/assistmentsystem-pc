    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                    <form id="form_advanced_validation" class="addRiasec" method="POST" action="{{ route('admin.add.riasec') }}">
                    @csrf
                    ...
                    <button type="button" style="margin-top: 10px;" class="btn btn-success waves-effect" id="add-career-pathway">+ Add Another Career Pathway</button><br><br>
            </div>
            <hr>
